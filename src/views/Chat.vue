<template>
  <div>
   <aside id="sidebar_rptb" class="sidebar_rptb" :class="[open == true? 'active': '']" @click="openModal" :style="[open == true ?{'width': '360px'}:{'width':'50px'}]">
       <div id="rptb" class="rptb" style="visibility: visible; height: 792px;" data-simplebar="init">
               ...
               <div class="simplebar-height-auto-observer-wrapper">
                ...
                <div class="simplebar-mask">
                    <div class="simplebar-offset" style="right: 0px; bottom: 0px;">
                        <div class="simplebar-content-wrapper" :style="[open == true ? {'height': 'auto','overflow': 'hidden scroll'}:{'height': '100%','overflow': 'scroll hidden'}]">
                        <div class="simplebar-content" style="padding: 0px;" @click="close">
                        <div id="rptb_header" class="rptb_header" @click="close">
                            <button type="button" class="btn_toggle-sidebar_rptb btn btn-link" @click="close">
                                <i :class="[open == true ? 'xi-2x xi-arrow-right': 'xi-2x xi-message']"></i>
                            </button>
...
안그래도 궁금했던 내용이었어용~</span></div>
                      ...
                      </div></div></div></div><div class="simplebar-placeholder" :style="[ open == true? {'width': 'auto','height': '800px'}:{'width': 'auto', 'height': '615px'}]">
                          </div></div>
                          <div class="simplebar-track simplebar-horizontal" :style="[ open == true? {'visibility': 'hidden'}:{'visibility': 'visible'}]">
                              <div class="simplebar-scrollbar" :style="[ open == true ? {'width': '0px','display': 'none'}:{'width': '25px', 'display': 'block','transform': 'translate3d(0px, 0px, 0px)'}]"></div></div><div class="simplebar-track simplebar-vertical" style="visibility: visible;"><div class="simplebar-scrollbar" style="height: 784px; display: block; transform: translate3d(0px, 8px, 0px);">
